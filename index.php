...
<head>
	...
	<meta name="keywords" content="top table soccer, table soccer, tischfussball, kicker, kickern, karte, map">
...
<body>
	...
	<script defer src="js/mylibs/sha256-min.js"></script>
	<!-- end scripts -->
	...
	*/
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#loginDialog').live('pagehide',function(event, ui) {
